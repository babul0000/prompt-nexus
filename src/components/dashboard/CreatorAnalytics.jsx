...
export function CreatorAnalytics({ prompts = [] }) {
    ...
    if (!prompts || prompts.length === 0) {
        return (
            <div className="bg-white dark:bg-[#090a16]/40 border border-zinc-200 dark:border-white/[0.06] rounded-2xl p-8 text-center backdrop-blur-md shadow-sm dark:shadow-none">
                <div className="flex flex-col items-center justify-center space-y-3">
                    <div className="p-4 bg-purple-500/10 border border-purple-500/20 text-purple-400 rounded-2xl">
                        <TrendingUp className="w-6 h-6 animate-pulse" />
                    </div>
                    <h3 className="text-base font-semibold text-zinc-900 dark:text-white">Analytics Pending</h3>
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-[#090a16]/50 border border-zinc-200 dark:border-white/[0.06] p-6 rounded-2xl flex flex-col gap-4 shadow-sm dark:shadow-none relative overflow-hidden">
