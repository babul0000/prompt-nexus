        ...
        <footer className="w-full bg-slate-50 dark:bg-[#030014] text-zinc-600 dark:text-gray-400 py-12 px-6 md:px-12 border-t border-zinc-200 dark:border-white/5 mt-auto transition-colors duration-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
                ...
                <div className="space-y-3">
                    <h4 className="text-zinc-900 dark:text-white font-semibold text-base">Explore</h4>
                    <ul className="space-y-2 text-sm text-zinc-550 dark:text-zinc-400">
                        <li>
                            <Link href="/" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Home</Link>
                        </li>
                        <li>
                            <Link href="/all-prompts" className="hover:text-zinc-900 dark:hover:text-white transition-colors">All Prompts</Link>
                        </li>
                        <li>
                            <Link href="/payment" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Pricing Plans</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="space-y-3">
                    <h4 className="text-zinc-900 dark:text-white font-semibold text-base">Legal</h4>
                    <ul className="space-y-2 text-sm text-zinc-550 dark:text-zinc-400">
                        <li>
                        ...
                        <li>
                            <Link href="#" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Cookie Policy</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="space-y-4">
                    <h4 className="text-zinc-900 dark:text-white font-semibold text-base">Stay Connected</h4>
                    ...
                    <div className="flex items-center gap-3">
                        {/* New X (Twitter) Logo */}
                        <Button isIconOnly size="sm" variant="light" className="text-zinc-500 dark:text-gray-400 hover:text-zinc-900 dark:hover:text-white min-w-8 h-8 rounded-lg border border-zinc-200 dark:border-white/5 bg-zinc-100 dark:bg-white/5 cursor-pointer">
