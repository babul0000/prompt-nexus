                ...
                >
                    {engines.map((item, idx) => (
                        <motion.div 
                            ...
                            className={`group flex flex-col gap-4 bg-[#090a16]/40 border border-white/[0.05] p-6 rounded-2xl transition-all duration-300 backdrop-blur-md hover:-translate-y-1 text-left ${item.hoverBorder} hover:shadow-[0_10px_25px_rgba(0,0,0,0.3)]`}
                        >
                            <div className="flex flex-col gap-1">
                                <h3 className="text-lg font-black text-white group-hover:text-purple-450 transition-colors">
                                    {item.name}
                                </h3>
                            ...
                            <p className="text-zinc-400 text-xs md:text-sm leading-relaxed mt-2">
                                {item.description}
                            </p>
                        </motion.div>
                    ))}
