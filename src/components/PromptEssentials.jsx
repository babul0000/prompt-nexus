                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 space-y-8 text-left">
                        <div className="space-y-4">
                            <div className="inline-flex items-center gap-2 bg-white/5 dark:bg-white/5 border border-zinc-200 dark:border-white/10 px-4.5 py-1.5 rounded-full text-xs text-purple-650 dark:text-purple-400 font-bold tracking-wide backdrop-blur-sm shadow-[0_0_15px_rgba(168,85,247,0.1)]">
                            ...
                            {checkmarks.map((item, idx) => (
                                <div key={idx} className="flex gap-3.5 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-655 dark:text-zinc-450 text-xs md:text-sm leading-relaxed mt-0.5">
                                            {item.desc}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-6 w-full flex justify-center lg:justify-end">
                        <motion.div 
                            ...
                            className="w-full max-w-lg rounded-2xl overflow-hidden border border-zinc-200 dark:border-white/[0.08] bg-zinc-950/95 dark:bg-[#050614]/90 shadow-[0_15px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_15px_40px_rgba(0,0,0,0.5)] backdrop-blur-xl"
                        >
                            {/* Window header */}
                            <div className="flex items-center justify-between px-5 py-3.5 bg-white/[0.03] border-b border-zinc-200 dark:border-white/[0.05]">
