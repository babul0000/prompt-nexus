...
export default function AdminAnalyticsMetrics({ metrics }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
      {/* Total Users */}
      <div className="bg-[#0a0d26] border border-[#13193e] p-5 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        <div className="absolute top-0 right-0 w-[120px] h-[60px] bg-purple-500/5 blur-[30px] rounded-full pointer-events-none" />
        <div className="space-y-1 text-left relative z-10">
          <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Total Users</span>
          <h3 className="text-3xl font-black text-white">{data.totalUsers}</h3>
          <p className="text-[10px] text-zinc-400 font-medium">Registered accounts</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-5 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Active Prompts</span>
          <h3 className="text-3xl font-black text-emerald-400">{data.activePrompts}</h3>
          <p className="text-[10px] text-zinc-400 font-medium">Approved and live</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-5 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Pending</span>
          <h3 className={`text-3xl font-black ${data.pendingApproval > 0 ? "text-amber-400" : "text-white"}`}>
            {data.pendingApproval}
          </h3>
          <p className="text-[10px] text-zinc-400 font-medium">Requires moderation</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-5 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          ...
          <h3 className="text-3xl font-black text-blue-400">${data.totalRevenue}</h3>
          <p className="text-[10px] text-zinc-400 font-medium">Subscription earnings</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-5 rounded-2xl flex flex-col justify-between shadow-lg relative overflow-hidden min-h-[110px] gap-2">
        ...
        <div className="flex items-center justify-between relative z-10 text-left">
          <div className="space-y-0.5">
            <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Conversion</span>
            <h3 className="text-2xl font-black text-indigo-400">{data.conversionRate}%</h3>
          </div>
