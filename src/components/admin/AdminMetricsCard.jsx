    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-6 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          ...
          <p className="text-[10px] text-zinc-400 font-medium">Active registrations</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-6 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Total Prompts</span>
          <h3 className="text-3xl font-black text-white">{data.totalPrompts}</h3>
          <p className="text-[10px] text-zinc-400 font-medium">Catalog submissions</p>
        </div>
      ...
      <div className="bg-[#0a0d26] border border-[#13193e] p-6 rounded-2xl flex items-center justify-between shadow-lg relative overflow-hidden min-h-[110px]">
        ...
        <div className="space-y-1 text-left relative z-10">
          <span className="text-[10px] font-bold text-zinc-500 tracking-wider uppercase block">Pending Approvals</span>
          <h3 className={`text-3xl font-black ${data.pendingModerations > 0 ? "text-amber-400" : "text-white"}`}>
