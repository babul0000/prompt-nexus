    ...
    if (sessionPending) {
        return (
            <div className="min-h-screen bg-[#030014] text-white flex flex-col items-center justify-center">
                ...
                <p className="mt-4 text-sm font-medium">Checking authorization...</p>
            </div>
        );
    }

    return (
        <div className="relative min-h-screen bg-[#030014] text-white pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            {/* Glowing ambient background grids/circles */}
            <div className="absolute top-[5%] left-1/4 -translate-x-1/2 w-[500px] h-[300px] bg-purple-600/5 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute top-[30%] right-1/4 translate-x-1/2 w-[600px] h-[350px] bg-blue-600/5 blur-[150px] rounded-full pointer-events-none" />
            ...
            <div className="max-w-5xl mx-auto relative z-10 space-y-12">
                ...
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto space-y-4">
                    <div className="p-3 bg-purple-500/10 border border-purple-500/20 text-purple-400 rounded-2xl shadow-[0_0_30px_rgba(124,58,237,0.15)] flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                    ...
                    <div className="bg-[#090a16]/60 border border-white/[0.06] rounded-3xl p-8 sm:p-10 flex flex-col justify-between backdrop-blur-md relative overflow-hidden group hover:border-purple-500/20 transition-all">
                        <div className="absolute top-0 right-0 w-[150px] h-[150px] bg-purple-600/5 blur-[50px] rounded-full pointer-events-none" />
                        
                        <div>
                            {/* Lifetime Plan Badge */}
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 mb-6">
                                Lifetime Plan
                            </span>
                            ...
                            {/* Pricing Section */}
                            <div className="flex items-baseline gap-1 text-white mb-8 border-b border-white/5 pb-6">
                                <span className="text-2xl font-bold text-zinc-400">$</span>
                                <span className="text-5xl font-black tracking-tight bg-gradient-to-r from-white to-zinc-350 bg-clip-text text-transparent">5.00</span>
                            ...
                            <ul className="space-y-4 text-left">
                                {[
                                    ...
                                    <li key={i} className="flex items-start gap-3 text-sm text-zinc-300 font-medium">
                                        <div className="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 mt-0.5">
                        ...
                        <div className="border-t border-white/5 pt-6 mt-8">
                            <div className="flex items-center gap-2.5 text-[11px] text-zinc-550 font-medium">
                    ...
                    <div className="bg-[#090a16]/60 border border-white/[0.06] rounded-3xl p-8 sm:p-10 flex flex-col justify-between backdrop-blur-md hover:border-blue-500/20 transition-all space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="relative flex items-center bg-[#09090b] border border-white/10 focus-within:border-purple-500/50 rounded-xl overflow-hidden transition-all px-4 py-3">
                                    <CreditCard className="w-5 h-5 text-zinc-550 shrink-0 mr-3" />
                                    <input 
                                        type="text" 
                                        ...
                                        className="w-full bg-transparent text-sm text-white focus:outline-none placeholder-zinc-550 pr-24 font-mono tracking-wider"
                                    />
                                    <button 
                                        onClick={handleAutofill}
                                        disabled={isUpgrading}
                                        className="absolute right-3 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 hover:text-emerald-350 border border-emerald-500/20 text-[10px] font-black uppercase tracking-wider px-2.5 py-1.5 rounded-lg transition-all active:scale-[0.97] cursor-pointer"
                                    >
                                        Autofill &gt;
                                    </button>
                                </div>
                        ...
                        <div className="border border-dashed border-purple-500/20 bg-[#7C3AED]/5 rounded-2xl p-5 text-center flex flex-col items-center gap-4 relative overflow-hidden">
                ...
                {isAlreadyPro && (
                    <div className="max-w-md mx-auto text-center">
                        <span className="inline-flex items-center gap-1.5 text-xs text-emerald-400 font-semibold bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-xl">
