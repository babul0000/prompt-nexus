        ...
        <div className="min-h-screen bg-[#030014] text-white p-4 sm:p-6 md:p-8 relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10 space-y-8">
                ...
                {savedPrompts.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-16 bg-[#090a16]/40 border border-white/5 rounded-2xl text-center space-y-4 max-w-xl mx-auto">
                        <Sparkles className="w-10 h-10 text-zinc-650 animate-bounce" />
                        <div className="space-y-1">
                            <h3 className="text-base font-semibold text-white">No Saved Prompts</h3>
