        ...
        <div className="relative min-h-screen bg-[#030014] text-white pt-10 pb-20 px-4 sm:px-6">
            ...
            <div className="max-w-6xl mx-auto relative z-10 space-y-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-b border-white/5 pb-8">
                    <div className="space-y-1">
                        <h1 className="text-3xl font-extrabold tracking-tight text-white leading-tight">
                            Welcome Back, <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">{user?.name || 'Member'}</span>! ✨
                        </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div className="bg-[#090a16]/60 border border-white/[0.06] hover:border-blue-500/30 p-6 rounded-2xl transition-all flex items-center justify-between">
                        <div className="space-y-1">
                            ...
                            <h3 className="text-2xl font-black text-white">{reviewsCount}</h3>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-[#090a16]/50 border border-white/[0.06] p-6 rounded-2xl flex flex-col gap-6 backdrop-blur-md">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-zinc-300">
                            <div className="p-4 bg-white/[0.01] border border-white/5 rounded-xl space-y-1">
                                ...
                                <p className="font-semibold text-white">{user?.name || 'Not configured'}</p>
                            </div>
                            <div className="p-4 bg-white/[0.01] border border-white/5 rounded-xl space-y-1">
                            ...
                            <div className="p-4 bg-white/[0.01] border border-white/5 rounded-xl space-y-1">
                                ...
                                <p className="font-semibold text-purple-400 capitalize">{user?.role || 'Regular Member'}</p>
                            </div>
                            <div className="p-4 bg-white/[0.01] border border-white/5 rounded-xl space-y-1">
                                <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wide">Account Status</span>
                                <span className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                    ...
                    <div className="lg:col-span-1 bg-[#090a16]/50 border border-white/[0.06] p-6 rounded-2xl flex flex-col gap-6 backdrop-blur-md justify-between">
