...
export default function SystemAnalyticsPage() {
  ...
  return (
    <div className="relative min-h-screen bg-transparent text-zinc-900 dark:text-white pt-6 pb-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="absolute top-[5%] left-1/4 -translate-x-1/2 w-[400px] h-[250px] bg-purple-655/5 blur-[100px] rounded-full pointer-events-none" />
      <div className="absolute top-[25%] right-1/4 translate-x-1/2 w-[400px] h-[250px] bg-blue-655/5 blur-[100px] rounded-full pointer-events-none" />
